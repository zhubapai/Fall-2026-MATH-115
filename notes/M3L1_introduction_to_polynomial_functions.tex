...
\draw[dashed, thick, domain=-2.6:-0.15, samples=40, smooth] plot (\x, {0.15*\x*\x*\x+0.7*\x});
\draw[thick, -{Latex}, domain=-2.7:-2.6, samples=2] plot (\x, {0.15*\x*\x*\x+0.7*\x});
\draw[dashed, thick, domain=0.15:2.6, samples=40, smooth] plot (\x, {0.15*\x*\x*\x+0.7*\x});
\draw[thick, -{Latex}, domain=2.6:2.7, samples=2] plot (\x, {0.15*\x*\x*\x+0.7*\x});
