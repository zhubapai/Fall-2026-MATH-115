...
Solve each inequality. Express the solution in interval notation.
...
Solve each double inequality. Express the solution in interval notation.
...
\begin{itemize}
    ...
    \item Solutions are typically expressed using interval notation and can be graphed on a number line.
\end{itemize}
\end{friendlyrule}
